...
- [YimMenuV2 Lua API](#yimmenuv2-lua-api)
  - [Contents](#contents)
  ...
  - [script](#script)
  - [event](#event)
      - [`event.register_handler(menu_event, handler)`](#eventregister_handlermenu_event-handler)
  - [menu](#menu)
      - [Top-level](#top-level)
      - [Submenu](#submenu)
      - [Category](#category)
  ...
  - [ImGui](#imgui)
      ...
      - [Cursor \& content region](#cursor--content-region)
      - [Scrolling](#scrolling)
      ...
      - [Inputs](#inputs)
      - [Colors](#colors)
      - [Trees \& headers](#trees--headers)
      - [Menus](#menus)
      - [Tooltips \& popups](#tooltips--popups)
      - [Tabs](#tabs)
      - [Tables](#tables)
      - [Draw list](#draw-list)
      - [Item \& input queries](#item--input-queries)
      - [Misc](#misc)
      - [Enum tables](#enum-tables)
  - [memory](#memory)
  - [pointer](#pointer)
      - [Construction \& address](#construction--address)
  ...
  - [ScriptFunction](#scriptfunction)
      - [`fn:call(param_string, ...) -> any`](#fncallparam_string----any)
  - [scripts](#scripts)
  - [natives](#natives)
  - [network](#network)
  - [tunables](#tunables)

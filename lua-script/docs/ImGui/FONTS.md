...
## Index
- [Dear ImGui: Using Fonts](#dear-imgui-using-fonts)
- [Index](#index)
- [Troubleshooting](#troubleshooting)
  - [(1) Invalid filename due to use of `\` or unexpected working directory.](#1-invalid-filename-due-to-use-of--or-unexpected-working-directory)
  - [(2) Invalid UTF-8 encoding of your non-ASCII strings.](#2-invalid-utf-8-encoding-of-your-non-ascii-strings)
  - [(3) Missing glyph ranges.](#3-missing-glyph-ranges)
  - [(4) Font atlas texture fails to upload to GPU.](#4-font-atlas-texture-fails-to-upload-to-gpu)
  - [(5) Reduce texture resizes/copy on startup](#5-reduce-texture-resizescopy-on-startup)
      - [Return to Index](#return-to-index)
- [New! Dynamic Fonts system in 1.92 (June 2025)](#new-dynamic-fonts-system-in-192-june-2025)
      - [Return to Index](#return-to-index-1)
- [How should I handle DPI in my application?](#how-should-i-handle-dpi-in-my-application)
      - [Return to Index](#return-to-index-2)
- [Fonts Loading Instructions](#fonts-loading-instructions)
      - [Return to Index](#return-to-index-3)
- [Loading Font Data from Memory](#loading-font-data-from-memory)
      - [Return to Index](#return-to-index-4)
- [Loading Font Data Embedded In Source Code](#loading-font-data-embedded-in-source-code)
      - [Return to Index](#return-to-index-5)
- [Using Icon Fonts](#using-icon-fonts)
      - [Return to Index](#return-to-index-6)
  - [Excluding Overlapping Ranges](#excluding-overlapping-ranges)
      - [Return to Index](#return-to-index-7)
- [Using FreeType Rasterizer (imgui\_freetype)](#using-freetype-rasterizer-imgui_freetype)
      - [Return to Index](#return-to-index-8)
- [Using Colorful Glyphs/Emojis](#using-colorful-glyphsemojis)
      - [Return to Index](#return-to-index-9)
- [Using Custom Glyph Ranges](#using-custom-glyph-ranges)
      - [Return to Index](#return-to-index-10)
- [Using Custom Colorful Icons](#using-custom-colorful-icons)
    - [Pseudo-code:](#pseudo-code)
      - [Return to Index](#return-to-index-11)
- [About Filenames](#about-filenames)
      - [Return to Index](#return-to-index-12)
- [About UTF-8 Encoding](#about-utf-8-encoding)
      - [Return to Index](#return-to-index-13)
- [Debug Tools](#debug-tools)
    - [Metrics/Debugger-\>Fonts](#metricsdebugger-fonts)
    - [UTF-8 Encoding Viewer\*\*](#utf-8-encoding-viewer)
      - [Return to Index](#return-to-index-14)
- [Credits/Licenses For Fonts Included In Repository](#creditslicenses-for-fonts-included-in-repository)
      - [Return to Index](#return-to-index-15)
- [Font Links](#font-links)
    - [ICON FONTS](#icon-fonts)
    - [REGULAR FONTS](#regular-fonts)
    - [MONOSPACE FONTS](#monospace-fonts)
      - [Return to Index](#return-to-index-16)
